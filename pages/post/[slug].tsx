  ...
  return (
    <main className="">
      ...
      <img
        ...
        alt=""
      />
      <article className="mx-auto max-w-7xl p-10 md:p-0 lg:p-0">
      ...
      <h4 className="text-center text-3xl font-bold">Leave A Comment Below</h4>
      <hr className="mx-auto mt-2  max-w-lg py-2" />
      {submitted ? (
        <div className=" my-10 mx-auto flex max-w-2xl flex-col bg-yellow-500 p-10 text-white">
          <h3 className="text-3xl font-bold">Thank You For Submitting</h3>
          <p>Once it has been aprroved, it will appear below</p>
        </div>
      ) : (
        <form
